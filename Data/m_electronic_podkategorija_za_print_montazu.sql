...
--
-- Table structure for table `podkategorija_za_print_montazu`
--

DROP TABLE IF EXISTS `podkategorija_za_print_montazu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_za_print_montazu` (
...
--
-- Dumping data for table `podkategorija_za_print_montazu`
--

LOCK TABLES `podkategorija_za_print_montazu` WRITE;
/*!40000 ALTER TABLE `podkategorija_za_print_montazu` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_za_print_montazu` ENABLE KEYS */;
UNLOCK TABLES;
