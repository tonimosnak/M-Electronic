...
--
-- Table structure for table `podkategorija_releji`
--

DROP TABLE IF EXISTS `podkategorija_releji`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_releji` (
...
--
-- Dumping data for table `podkategorija_releji`
--

LOCK TABLES `podkategorija_releji` WRITE;
/*!40000 ALTER TABLE `podkategorija_releji` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_releji` ENABLE KEYS */;
UNLOCK TABLES;
