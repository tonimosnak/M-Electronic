...
--
-- Table structure for table `podkategorija_baterije`
--

DROP TABLE IF EXISTS `podkategorija_baterije`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_baterije` (
...
--
-- Dumping data for table `podkategorija_baterije`
--

LOCK TABLES `podkategorija_baterije` WRITE;
/*!40000 ALTER TABLE `podkategorija_baterije` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_baterije` ENABLE KEYS */;
UNLOCK TABLES;
