...
--
-- Table structure for table `podkategorija_diode`
--

DROP TABLE IF EXISTS `podkategorija_diode`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_diode` (
...
--
-- Dumping data for table `podkategorija_diode`
--

LOCK TABLES `podkategorija_diode` WRITE;
/*!40000 ALTER TABLE `podkategorija_diode` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_diode` ENABLE KEYS */;
UNLOCK TABLES;
