...
--
-- Table structure for table `podkategorija_za_kompjutere`
--

DROP TABLE IF EXISTS `podkategorija_za_kompjutere`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_za_kompjutere` (
...
--
-- Dumping data for table `podkategorija_za_kompjutere`
--

LOCK TABLES `podkategorija_za_kompjutere` WRITE;
/*!40000 ALTER TABLE `podkategorija_za_kompjutere` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_za_kompjutere` ENABLE KEYS */;
UNLOCK TABLES;
