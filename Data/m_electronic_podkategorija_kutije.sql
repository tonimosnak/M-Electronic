...
--
-- Table structure for table `podkategorija_kutije`
--

DROP TABLE IF EXISTS `podkategorija_kutije`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_kutije` (
...
--
-- Dumping data for table `podkategorija_kutije`
--

LOCK TABLES `podkategorija_kutije` WRITE;
/*!40000 ALTER TABLE `podkategorija_kutije` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_kutije` ENABLE KEYS */;
UNLOCK TABLES;
