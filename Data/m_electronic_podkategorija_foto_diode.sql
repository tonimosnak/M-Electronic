...
--
-- Table structure for table `podkategorija_foto_diode`
--

DROP TABLE IF EXISTS `podkategorija_foto_diode`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_foto_diode` (
...
--
-- Dumping data for table `podkategorija_foto_diode`
--

LOCK TABLES `podkategorija_foto_diode` WRITE;
/*!40000 ALTER TABLE `podkategorija_foto_diode` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_foto_diode` ENABLE KEYS */;
UNLOCK TABLES;
