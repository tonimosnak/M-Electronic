...
--
-- Table structure for table `podkategorija_zvucne_kutije`
--

DROP TABLE IF EXISTS `podkategorija_zvucne_kutije`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_zvucne_kutije` (
...
--
-- Dumping data for table `podkategorija_zvucne_kutije`
--

LOCK TABLES `podkategorija_zvucne_kutije` WRITE;
/*!40000 ALTER TABLE `podkategorija_zvucne_kutije` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_zvucne_kutije` ENABLE KEYS */;
UNLOCK TABLES;
