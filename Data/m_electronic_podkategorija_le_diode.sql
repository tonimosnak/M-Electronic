...
--
-- Table structure for table `podkategorija_le_diode`
--

DROP TABLE IF EXISTS `podkategorija_le_diode`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_le_diode` (
...
--
-- Dumping data for table `podkategorija_le_diode`
--

LOCK TABLES `podkategorija_le_diode` WRITE;
/*!40000 ALTER TABLE `podkategorija_le_diode` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_le_diode` ENABLE KEYS */;
UNLOCK TABLES;
