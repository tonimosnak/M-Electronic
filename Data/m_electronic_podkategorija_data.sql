...
--
-- Table structure for table `podkategorija_data`
--

DROP TABLE IF EXISTS `podkategorija_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_data` (
...
--
-- Dumping data for table `podkategorija_data`
--

LOCK TABLES `podkategorija_data` WRITE;
/*!40000 ALTER TABLE `podkategorija_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_data` ENABLE KEYS */;
UNLOCK TABLES;
