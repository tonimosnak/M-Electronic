...
--
-- Table structure for table `podkategorija_mikrofoni`
--

DROP TABLE IF EXISTS `podkategorija_mikrofoni`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_mikrofoni` (
...
--
-- Dumping data for table `podkategorija_mikrofoni`
--

LOCK TABLES `podkategorija_mikrofoni` WRITE;
/*!40000 ALTER TABLE `podkategorija_mikrofoni` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_mikrofoni` ENABLE KEYS */;
UNLOCK TABLES;
