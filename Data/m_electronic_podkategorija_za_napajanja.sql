...
--
-- Table structure for table `podkategorija_za_napajanja`
--

DROP TABLE IF EXISTS `podkategorija_za_napajanja`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_za_napajanja` (
...
--
-- Dumping data for table `podkategorija_za_napajanja`
--

LOCK TABLES `podkategorija_za_napajanja` WRITE;
/*!40000 ALTER TABLE `podkategorija_za_napajanja` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_za_napajanja` ENABLE KEYS */;
UNLOCK TABLES;
