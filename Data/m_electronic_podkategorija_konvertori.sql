...
--
-- Table structure for table `podkategorija_konvertori`
--

DROP TABLE IF EXISTS `podkategorija_konvertori`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_konvertori` (
...
--
-- Dumping data for table `podkategorija_konvertori`
--

LOCK TABLES `podkategorija_konvertori` WRITE;
/*!40000 ALTER TABLE `podkategorija_konvertori` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_konvertori` ENABLE KEYS */;
UNLOCK TABLES;
