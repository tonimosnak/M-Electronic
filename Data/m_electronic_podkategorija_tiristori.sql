...
--
-- Table structure for table `podkategorija_tiristori`
--

DROP TABLE IF EXISTS `podkategorija_tiristori`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_tiristori` (
...
--
-- Dumping data for table `podkategorija_tiristori`
--

LOCK TABLES `podkategorija_tiristori` WRITE;
/*!40000 ALTER TABLE `podkategorija_tiristori` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_tiristori` ENABLE KEYS */;
UNLOCK TABLES;
