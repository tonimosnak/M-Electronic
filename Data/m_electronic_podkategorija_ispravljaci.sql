...
--
-- Table structure for table `podkategorija_ispravljaci`
--

DROP TABLE IF EXISTS `podkategorija_ispravljaci`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_ispravljaci` (
...
--
-- Dumping data for table `podkategorija_ispravljaci`
--

LOCK TABLES `podkategorija_ispravljaci` WRITE;
/*!40000 ALTER TABLE `podkategorija_ispravljaci` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_ispravljaci` ENABLE KEYS */;
UNLOCK TABLES;
