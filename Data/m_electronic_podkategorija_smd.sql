...
--
-- Table structure for table `podkategorija_smd`
--

DROP TABLE IF EXISTS `podkategorija_smd`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_smd` (
...
--
-- Dumping data for table `podkategorija_smd`
--

LOCK TABLES `podkategorija_smd` WRITE;
/*!40000 ALTER TABLE `podkategorija_smd` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_smd` ENABLE KEYS */;
UNLOCK TABLES;
