...
--
-- Table structure for table `podkategorija_torusni`
--

DROP TABLE IF EXISTS `podkategorija_torusni`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_torusni` (
...
--
-- Dumping data for table `podkategorija_torusni`
--

LOCK TABLES `podkategorija_torusni` WRITE;
/*!40000 ALTER TABLE `podkategorija_torusni` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_torusni` ENABLE KEYS */;
UNLOCK TABLES;
