...
--
-- Table structure for table `podkategorija_pribor`
--

DROP TABLE IF EXISTS `podkategorija_pribor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_pribor` (
...
--
-- Dumping data for table `podkategorija_pribor`
--

LOCK TABLES `podkategorija_pribor` WRITE;
/*!40000 ALTER TABLE `podkategorija_pribor` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_pribor` ENABLE KEYS */;
UNLOCK TABLES;
