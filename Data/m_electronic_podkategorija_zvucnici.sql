...
--
-- Table structure for table `podkategorija_zvucnici`
--

DROP TABLE IF EXISTS `podkategorija_zvucnici`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_zvucnici` (
...
--
-- Dumping data for table `podkategorija_zvucnici`
--

LOCK TABLES `podkategorija_zvucnici` WRITE;
/*!40000 ALTER TABLE `podkategorija_zvucnici` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_zvucnici` ENABLE KEYS */;
UNLOCK TABLES;
