...
--
-- Table structure for table `podkategorija_punjaci`
--

DROP TABLE IF EXISTS `podkategorija_punjaci`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_punjaci` (
...
--
-- Dumping data for table `podkategorija_punjaci`
--

LOCK TABLES `podkategorija_punjaci` WRITE;
/*!40000 ALTER TABLE `podkategorija_punjaci` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_punjaci` ENABLE KEYS */;
UNLOCK TABLES;
