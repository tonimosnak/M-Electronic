...
--
-- Table structure for table `podkategorija_tasteri`
--

DROP TABLE IF EXISTS `podkategorija_tasteri`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_tasteri` (
...
--
-- Dumping data for table `podkategorija_tasteri`
--

LOCK TABLES `podkategorija_tasteri` WRITE;
/*!40000 ALTER TABLE `podkategorija_tasteri` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_tasteri` ENABLE KEYS */;
UNLOCK TABLES;
