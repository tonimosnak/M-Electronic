...
--
-- Table structure for table `podkategorija_ugradni`
--

DROP TABLE IF EXISTS `podkategorija_ugradni`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_ugradni` (
...
--
-- Dumping data for table `podkategorija_ugradni`
--

LOCK TABLES `podkategorija_ugradni` WRITE;
/*!40000 ALTER TABLE `podkategorija_ugradni` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_ugradni` ENABLE KEYS */;
UNLOCK TABLES;
