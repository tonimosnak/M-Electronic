...
--
-- Table structure for table `podkategorija_otpornici`
--

DROP TABLE IF EXISTS `podkategorija_otpornici`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_otpornici` (
...
--
-- Dumping data for table `podkategorija_otpornici`
--

LOCK TABLES `podkategorija_otpornici` WRITE;
/*!40000 ALTER TABLE `podkategorija_otpornici` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_otpornici` ENABLE KEYS */;
UNLOCK TABLES;
