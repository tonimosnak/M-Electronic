...
--
-- Table structure for table `podkategorija_instrumenti`
--

DROP TABLE IF EXISTS `podkategorija_instrumenti`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_instrumenti` (
...
--
-- Dumping data for table `podkategorija_instrumenti`
--

LOCK TABLES `podkategorija_instrumenti` WRITE;
/*!40000 ALTER TABLE `podkategorija_instrumenti` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_instrumenti` ENABLE KEYS */;
UNLOCK TABLES;
