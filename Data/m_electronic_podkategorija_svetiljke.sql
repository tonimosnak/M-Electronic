...
--
-- Table structure for table `podkategorija_svetiljke`
--

DROP TABLE IF EXISTS `podkategorija_svetiljke`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_svetiljke` (
...
--
-- Dumping data for table `podkategorija_svetiljke`
--

LOCK TABLES `podkategorija_svetiljke` WRITE;
/*!40000 ALTER TABLE `podkategorija_svetiljke` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_svetiljke` ENABLE KEYS */;
UNLOCK TABLES;
