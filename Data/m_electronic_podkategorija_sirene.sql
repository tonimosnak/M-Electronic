...
--
-- Table structure for table `podkategorija_sirene`
--

DROP TABLE IF EXISTS `podkategorija_sirene`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_sirene` (
...
--
-- Dumping data for table `podkategorija_sirene`
--

LOCK TABLES `podkategorija_sirene` WRITE;
/*!40000 ALTER TABLE `podkategorija_sirene` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_sirene` ENABLE KEYS */;
UNLOCK TABLES;
