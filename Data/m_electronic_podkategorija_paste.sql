...
--
-- Table structure for table `podkategorija_paste`
--

DROP TABLE IF EXISTS `podkategorija_paste`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `podkategorija_paste` (
...
--
-- Dumping data for table `podkategorija_paste`
--

LOCK TABLES `podkategorija_paste` WRITE;
/*!40000 ALTER TABLE `podkategorija_paste` DISABLE KEYS */;
/*!40000 ALTER TABLE `podkategorija_paste` ENABLE KEYS */;
UNLOCK TABLES;
